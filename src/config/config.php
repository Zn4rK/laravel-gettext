...
return array(
	...
	*/
	...
	|--------------------------------------------------------------------------
	| 
	| This is the target constant that we will try to overwrite with our locale
	| 
	*/
	...
	|--------------------------------------------------------------------------
	| 
	| Since PHP uses the locale to set the decimal point on numbers you can
	| Choose to reset it back to 'C' here. 
	| 
	*/
	...
	*/
	...
	|--------------------------------------------------------------------------
	| 
	| Here you can specify an array of paths that the gettext library should 
	| include in the generation of the POT-file
	|
	| Don't include a trailing slash.
	|
	*/
